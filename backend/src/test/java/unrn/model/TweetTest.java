...
class TweetTest {
    ...
    void crearTweetOriginal_textoValido() {
        ...
        // Verificación
        assertEquals("Texto válido", tweet.getText(), "El texto del tweet no coincide con el esperado");
        assertNull(tweet.getOriginalTweet(), "El tweet original debe ser null para un tweet original");
        assertEquals(user, tweet.getAuthor(), "El autor del tweet no coincide con el esperado");
    }
    ...
    void crearRetweet_valido() {
        ...
        // Verificación
        assertEquals("", retweet.getText(), "El texto del retweet debe estar vacío");
        assertEquals(originalTweet, retweet.getOriginalTweet(), "El retweet no referencia correctamente al tweet original");
        assertEquals(user2, retweet.getAuthor(), "El autor del retweet no coincide con el esperado");
    }
